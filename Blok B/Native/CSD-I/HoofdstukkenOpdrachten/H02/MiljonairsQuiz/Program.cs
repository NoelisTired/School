while (true)
{
    ...
    Console.WriteLine("Welke tekens gebruik je rondom een string in je code?\na. Accolades\nb.Enkele aanhalingstekens\nc.Dubbele aanhalingstekens\nd. Enkele of dubbele aanhalingstekens\n\nJouw antwoord:");
